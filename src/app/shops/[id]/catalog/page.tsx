            ...
            <section className="px-3 sm:px-6 py-4 sm:py-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
                {sortedProducts.map((item) => (
                  <div
                    key={item.id}
                    className="bg-white rounded-xl sm:rounded-2xl border border-[#46C4FF33] hover:shadow-lg transition-shadow overflow-hidden"
                  >
                    {/* Image Container */}
                    <div className="aspect-square relative overflow-hidden bg-gray-100">
                      ...
                      {/* Badge */}
                      {item.badge && (
                        <span className="absolute top-2 left-2 text-[10px] sm:text-xs bg-[#99daf9] text-[#0056A3] px-2 py-0.5 sm:px-3 sm:py-1 rounded-full shadow-sm border border-[#46C4FF] z-10">
                          {item.badge}
                        </span>
                      )}
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 w-7 h-7 sm:w-8 sm:h-8 bg-white border border-[#46C4FF33] rounded-full flex items-center justify-center hover:scale-110 transition-all shadow-sm z-10"
                      >
                        <Heart
