    ...
    <div className="flex flex-col items-start justify-center overflow-x-hidden antialiased font-sans dark:bg-black">
      ...
      >
        <div className="absolute inset-0 w-full">
          <img ref={setImageRef(0)} src="/home/TopWaveBG.svg" className="absolute top-0 left-0 w-1/2 z-0 pointer-events-none" draggable="false" alt="" />
          <img ref={setImageRef(1)} src="/home/ShopsBG.svg" className="absolute bottom-0 left-0 lg:w-3/5 z-0 pointer-events-none" draggable="false" alt="" />
          <img ref={setImageRef(2)} src="/home/BottomWave.png" className="absolute bottom-0 z-20 lg:z-0 left-0 pointer-events-none" draggable="false" alt="" />
        </div>
        ...
        <div className="relative flex flex-col lg:flex-row w-full h-screen z-10">
          <div className="flex flex-col p-5 ml-2 lg:ml-10 mt-20 mb-5 lg:mt-40 md:basis-2/3 pointer-events-none">
            <div ref={titleRef}>
              <h1 className="font-montserrat text-5xl md:text-6xl font-black text-white">EMPOWERING LOCAL</h1>
              <h1 className="text-5xl md:text-6xl font-montserrat font-black text-white">EXPANDING REACH</h1>
            </div>
            <p ref={subtitleRef} className="text-xl font-montserrat font-semibold md:text-2xl text-white">
              Menghubungkan bisnis lokal dengan <span className="hidden md:inline"><br /></span>orang-orang di sekitarnya
            </p>
          </div>
          <img ref={setImageRef(3)} src="/home/SalesPerson.svg" className="absolute bottom-0 right-0 w-[250px] lg:w-[400px] z-0 lg:z-10" alt="" />
        </div>
      </div>

      {/* Middle Section */}
      <div className="relative w-full flex flex-col justify-center items-center">
        <img src="/home/MiddleBG.png" className="absolute inset-0 w-full h-full object-cover" alt="" />
        <div className="flex flex-col items-center w-full h-full">
          <div className="flex w-full justify-center relative h-full">

            {/* Circle & Phone */}
            <div className="relative z-0 hidden lg:flex basis-1/2">
              <div ref={circleRef} className="w-0 h-0 md:w-128 md:h-128 mt-5 rounded-full bg-[#1BE399] absolute z-0 left-[-5vw]"></div>
              <img ref={phoneRef} src="/home/Phone.svg" alt="" className="absolute top-[-5vw] w-[75%]" />
            </div>

            {/* About Card */}
            <div className="lg:basis-3/4 relative z-10 flex justify-center lg:justify-end">
              <div ref={aboutCardRef} className="bg-[#032D51] p-10 flex flex-col font-montserrat basis-3/4 lg:rounded-tr-none lg:rounded-br-none rounded-xl w-full">
                ...
                <p className="text-white font-semibold font-nunitoSans text-center lg:text-start text-xl lg:text-justify pt-4 lg:mr-20">
                  <span className="text-[#1EED8C]">Loca</span> merupakan platform yang membawa bisnis lokal ke dunia digital, membantu mereka berkembang dan tetap terhubung dengan pelanggan
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-[#0099EB] relative z-10 h-full w-full">
        <div className="flex flex-col items-center mt-30 relative">
          <div className="absolute z-30 flex flex-col mt-[-20%] md:mt-0 w-full h-full items-center">
            <p ref={finalTitleRef} className="text-white font-montserrat font-black text-3xl lg:text-4xl text-center">
              CARILAH BISNIS <br /> LOKAL SEKARANG
            </p>
            <a ref={finalBtnRef} href="/map" className="bg-white mt-5 text-center text-black font-bold px-10 py-2 rounded-xl">
              Search now
            </a>
          </div>
        </div>
        ...
        <div className="relative bg-[#0099EB] w-full">
          ...
          <div className="flex flex-col items-center mt-[-10%]">
            ...
            <img src="/home/ServiceStall.svg" className="w-[25%] relative mt-[-5%]" alt="" />
          </div>
        </div>
      </div>
    </div>
